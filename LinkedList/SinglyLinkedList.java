...
public class SinglyLinkedList<T> {
    ...
    public void addToFront(T data) {
        ...
        if (size == 0) {
            ...
            tail = new SinglyLinkedListNode<T>(tail.getData(), null);
            head = new SinglyLinkedListNode<T>(data, tail);
        } else {
            SinglyLinkedListNode<T> newHead = new SinglyLinkedListNode<T>(data, null);
    ...
    public void addToBack(T data) {
        ...
        if (size == 0) {
            ...
            SinglyLinkedListNode<T> newTail = new SinglyLinkedListNode<T>(data, null);
